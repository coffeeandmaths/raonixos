# Generated by Powerlevel10k configuration wizard on 2025-03-27 at 22:16 GMT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-v3 + powerline, large icons, rainbow, unicode,
# angled separators, flat heads, sharp tails, 2 lines, disconnected, no frame, sparse,
